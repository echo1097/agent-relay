...
func Run(ctx context.Context, path string, logger *slog.Logger, registry *agents.Registry) (returnErr error) {
	if registry == nil {
	...
	logger.Info("daemon started", "pid", os.Getpid(), "mode", "local registry")
